          ...
          <div class="p-4">
            <div class="flex items-center">
              <div class="w-0 flex-1 flex justify-between">
                ...
                <button
                  type="button"
                  class="mr-3 flex-shrink-0 bg-white rounded-md text-sm font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  لغو
                </button>
              </div>
        ...
        >
          <div class="p-4">
            <div class="flex items-start">
              ...
              <div class="mr-3 w-0 flex-1 pt-0.5">
                <p class="text-sm font-medium text-gray-900">عملیت انجام شد</p>
                <p class="mt-1 text-sm text-gray-500">
                  لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ
                </p>
                <div class="mt-3 flex space-x-7 space-x-reverse">
                  <button
                    type="button"
...
<script setup>
  import { ref } from 'vue';
  import { CheckCircleIcon, InboxIcon } from '@heroicons/vue/outline';
