<template>
  <div class="mr-8">
    ...
    <div class="space-x-4 space-x-reverse space-y-4 my-8">
      ...
      <button
        type="button"
        class="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
      >
        دکمه
      </button>
      <button
    ...
    <div class="space-x-4 space-x-reverse space-y-4 my-8">
      ...
      >
        <MailIcon class="-mr-1 ml-3 h-5 w-5" aria-hidden="true" />
        دکمه
      </button>
      <button
        type="button"
      ...
      >
        <MailIcon class="-mr-1 ml-2 h-5 w-5" aria-hidden="true" />
        دکمه
      </button>
      <button
        type="button"
      ...
      >
        <MailIcon class="-mr-0.5 ml-2 h-4 w-4" aria-hidden="true" />
        دکمه
      </button>
    </div>
    ...
    <div class="space-x-4 space-x-reverse space-y-4 my-8">
      ...
      <button
        type="button"
        class="inline-flex items-center px-3.5 py-2 border border-transparent text-sm leading-4 font-medium rounded-full shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
      >
        دکمه
      </button>
      <button
    ...
    <div class="space-x-4 space-x-reverse my-8">
      <button
        type="button"
        class="inline-flex items-center p-3 border border-transparent rounded-full shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
      >
